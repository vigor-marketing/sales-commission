...
export default function ContractDetailPage() {
  ...
  const recordColumns = [
    ...
    { colKey: 'amountCNY', title: '人民币（¥）', width: 105, align: 'right' as const, cell: ({ row }: { row: HistoryRecord }) => <span style={{ fontVariantNumeric: 'tabular-nums' }}>{fmtMoney(row.paymentPlan[0]?.amountCNY ?? 0)}</span> },
